...
const game = {
    ...
    choicesClass: {
        scissors: 'main-middle-outcome-picked-inner-itself-scissors',
        spock: 'main-middle-outcome-picked-inner-itself-spock',
...
for (let i = 0; i < playerChoiceButtons.length; i++) {
    playerChoiceButtons[i].addEventListener('click', () => {
        ...
        pickedByPlayerOutcomeContainer.innerHTML = game.choiceSvgs[playerChoiceButtons[i].value];
        pickedByPlayerOutcomeContainer.classList.add(game.choicesClass[playerChoiceButtons[i].value]);
...
function theHousePicking() {
    ...
    pickedByHouseOutcomeContainer.innerHTML = game.choiceSvgs[pickedByHouse];
    pickedByHouseOutcomeContainer.classList.add(game.choicesClass[pickedByHouse]);
...
function checkWhoWonTheGame() {
    ...
    outcomeContainer.classList.add('main-middle-outcome-active');
};
...
function playAgain() {
    game.housePicked = '',
    game.playerPicked = '',
    pickedByPlayerOutcomeContainer.setAttribute('class', 'main-middle-outcome-picked-inner-itself');
    pickedByHouseOutcomeContainer.setAttribute('class', 'main-middle-outcome-picked-inner-itself');
